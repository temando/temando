...
class Ewave_Temando_Block_Product_Shipping extends Mage_Core_Block_Template
{
    ...
    public function getCountryId()
    {
        if (Mage::getSingleton('customer/session')->getData('estimate_product_shipping')) {
            Mage::getSingleton('customer/session')->getData('estimate_product_shipping')->getCountryId();
        }
