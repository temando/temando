...
class Ewave_Temando_Block_Adminhtml_Manifest_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        /* @var $collection Ewave_Temando_Model_Manifest */
...
//            'options' => Mage::helper('temando')->getLocationList(),
        ...
        /*$this->addColumn('end_date', array(
            'header' => Mage::helper('temando')->__('End Date'),
        	'width' => '100px',
        	'type' => 'date',
            'index' => 'end_date',
        ));*/
