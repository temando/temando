...
class Ewave_Temando_Block_Adminhtml_Manifest_Filter_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        /*$fieldset->addField('to', 'date', array(
            ...
            'format'    => $dateFormatIso,
            'image'     => $this->getSkinUrl('images/grid-cal.gif'),
            'label'     => Mage::helper('temando')->__('To'),
            'title'     => Mage::helper('temando')->__('To'),
            'required'  => true
        ));*/
