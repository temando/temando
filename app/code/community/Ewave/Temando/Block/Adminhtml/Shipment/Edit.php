...
//            $this->$add_button_method('cancel', array(
//		'label' => Mage::helper('temando')->__('Cancel Booking'),
//		'id'	=> 'cancel',
//		'onclick' => "window.location = '" . $this->getUrl('*/*/cancel', array('id' => $this->getRequest()->getParam('id'))) . "'",
//		'class' => 'delete',
//	    ));
        }
