...
class Ewave_Temando_Adminhtml_ManifestController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function addAction()
    {
        ...
        $post = $this->_filterDates($post, array('from', 'to'));
    ...
    //            'endReadyDate'     => isset($post['to'])?$post['to']:'',
    ...
    public function manifestAction()
    {
        ...
        /* @var $manifest Ewave_Temando_Model_Manifest */
        if ($manifest->getId()) {
