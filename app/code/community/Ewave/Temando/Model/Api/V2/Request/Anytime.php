...
class Ewave_Temando_Model_Api_V2_Request_Anytime extends Mage_Core_Model_Abstract {
	...
	parent::_construct();
	$this->_init('temando/api_v2_request_anytime');
    }
	...
	$this->_ready_date = Mage::helper('temando/v2')->getReadyDate($timestamp);
	return $this;
    }
