...
class Ewave_Temando_Model_Mysql4_Quote_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
     ...
     *
     * @param Ewave_Temando_Model_Quote $a the first quote.
     * @param Ewave_Temando_Model_Quote $b the second quote.
     *
     * @return Ewave_Temando_Model_Quote
     */
