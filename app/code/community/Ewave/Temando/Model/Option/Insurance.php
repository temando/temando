...
class Ewave_Temando_Model_Option_Insurance extends Ewave_Temando_Model_Option_Boolean
{
     ...
     * (Ewave_Temando_Model_System_Config_Source_Insurance). These include
    ...
    {
        switch ($value) {
            case Ewave_Temando_Model_System_Config_Source_Insurance::DISABLED:
                $this->setForcedValue(self::NO);
                break;
                
            case Ewave_Temando_Model_System_Config_Source_Insurance::MANDATORY:
                $this->setForcedValue(self::YES);
                break;
                
            case Ewave_Temando_Model_System_Config_Source_Insurance::OPTIONAL:
