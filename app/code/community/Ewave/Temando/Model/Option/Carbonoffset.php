...
class Ewave_Temando_Model_Option_Carbonoffset extends Ewave_Temando_Model_Option_Boolean
{
     ...
     * (Ewave_Temando_Model_System_Config_Source_Carbon). These include
    ...
    {
        switch ($value) {
            case Ewave_Temando_Model_System_Config_Source_Carbon::DISABLED:
                $this->setForcedValue(self::NO);
                break;
                
            case Ewave_Temando_Model_System_Config_Source_Carbon::MANDATORY:
                $this->setForcedValue(self::YES);
                break;
                
            case Ewave_Temando_Model_System_Config_Source_Carbon::OPTIONAL:
