...
abstract class Ewave_Temando_Model_Option_Abstract extends Varien_Object
{
     ...
     *
     * @var Ewave_Temando_Model_Option_Action_Abstract
     */
    ...
    protected function _setupAction()
    {
        ...
        if (!$this->_action) {
            throw Mage::exception('Ewave_Temando', 'Incorrect action model for option.');
        }
    }
     ...
     *
     * @return Ewave_Temando_Model_Option_Abstract
     */
